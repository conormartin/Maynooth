...
int main()
{
    ...
    MyComplex numAdd(num1+(num2));
    cout << "The sum of " << num1Real << " + " << num1Image << " and " << num2Real << " + " << num2Image << "i is ";
    numAdd.print(); 

    //Subtraction function call
    MyComplex numSub(num1-(num2));
    cout << num1Real << " + " << num1Image << " minus " << num2Real << " + " << num2Image << "i is : ";
    numSub.print();

    MyComplex numMult(num1*(num2));
    cout << num1Real << " + " << num1Image << " multiplied by " << num2Real << " + " << num2Image << "i is : ";
    numMult.print();
